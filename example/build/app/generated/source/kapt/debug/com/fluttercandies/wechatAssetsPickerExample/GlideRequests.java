...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.fluttercandies.wechatAssetsPickerExample.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.fluttercandies.wechatAssetsPickerExample.GlideOptions().apply(toSet));
    }
  }
}
